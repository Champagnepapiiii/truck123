...
import com.mondaybs.monday.Buyers.HomeActivity;
import com.mondaybs.monday.Buyers.MainActivity;
import com.mondaybs.monday.Buyers.SplashActivity;
import com.mondaybs.monday.Model.Products;
import com.mondaybs.monday.R;
import com.mondaybs.monday.ViewHolder.ItemViewHolder;
                       ...
                       holder.txtProductPrice.setText("Price = Rs " + model.getPrice());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                ...
                                builder.setTitle("Do you want to delete this item or product. Are you sure?");
    ...
    private void deleteProduct(String productID)
    {
        unverifiedProductsRef.child(productID)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    {
                        Toast.makeText(SellerHomeActivity.this, "The item has been deleted.", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}
