...
import com.example.monday.Model.Cart;
import com.example.monday.Prevalent.Prevalent;
import com.example.monday.R;
import com.example.monday.ViewHolder.CartViewHolder;
...
//                //When the user clicks on the next Button on the cart page, we will redirecting him into the confirm final order page.
                NextProcessBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        txtTotalAmount.setText("Total Price= Rs" + String.valueOf(overTotalPrice));// we need to receive the total price on the confirm final order now, we will define a totalAmount variable and we will use an intent
