...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private void addingToCartList() {
        // we will find the time when the customer is adding the product to the cart and we wil be able to sort which
        //items order was taken first
        ...
        // To save the above data in the firebase database, we need to create a reference for the firebase
